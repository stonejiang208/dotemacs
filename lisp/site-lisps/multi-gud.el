;;; multi-gud.el --- Grand Unified Debugger mode for running GDB and other
;;; debuggers
...
;; Based on gud.el from GNU Emacs version 1.120.
...
(put 'gud-comint-buffer 'permanent-local t)
...
`gud-gdb-command-name' for all future sessions."
...
(defun gud-kill-buffer-hook ()
  ...
  (setq gud-session-buffer gud-comint-buffer)
  (condition-case nil
