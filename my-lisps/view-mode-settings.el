...
;; Time-stamp: <2014-04-01 20:51:23 by jiangtao>
(require 'util)
(eal-define-keys
 'view-mode-map
...
(defun switch-major-mode-with-view-mode ()
  "Run `switch-major-mode-with-view-mode' with `view-mode'. "
	(interactive)
	(let ((view view-mode))
		(call-interactively 'switch-major-mode)
		(view-mode (if view 1 -1))))

(eal-define-keys-commonly
 global-map
 `(("C-x q" switch-major-mode-with-view-mode)))
